...
Gameta will extract git information and create the .gameta file which stores 
...
If your repository contains a .gameta file generated by Gameta, simply run the
